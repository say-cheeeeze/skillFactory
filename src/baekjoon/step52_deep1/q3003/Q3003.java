package baekjoon.step52_deep1.q3003;
...
public class Q3003 {
	...
	public static void main( String[] args ) {
		...
		int[] targetPieces = new int[] { 1, 1, 2, 2, 2, 8 };
		int[] foundedPieces = new int[6];
		int[] solutionPieces = new int[6];
		Scanner sc = new Scanner( System.in );
		
		for ( int i = 0; i < foundedPieces.length; i++ ) {
			foundedPieces[i] = sc.nextInt();
			solutionPieces[i] = targetPieces[i] - foundedPieces[i];
		}
		for ( int num : solutionPieces ) {
